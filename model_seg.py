...
class UNetResNet(torch.nn.Module):
    ...
    def __init__(self, num_classes, in_channels):
      ...
      self.conv6ch = torch.nn.Conv2d(in_channels,64,kernel_size=(7,7),stride=(2,2),padding=(3,3),bias=False)
      self.conv1 = torch.nn.Sequential(self.conv6ch, self.encoder.bn1, self.encoder.relu, self.pool)
...
if __name__ == '__main__':
    unet = UNetResNet(num_classes=7, in_channels=10)
